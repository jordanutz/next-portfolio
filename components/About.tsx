  ...
  return (
    <Container isStretched ref={about} className="about">
      ...
      <p className="about__text">
        ...
        <Anchor href="https://devmountain.com/"> DevMountain</Anchor>. I&apos;m
        natually invested in the types of problems I encounter daily and the
        experience points each one unlocks.
      </p>
    </Container>
  );
};
